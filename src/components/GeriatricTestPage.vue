...
export default {
  data: () => ({
    ...
    headers1: [
      { text: '', value:'form', sortable: false, align: 'center', width: 275},
      { text: '예', value: 'yes', sortable: false, align: 'center', width: 274},
      { text: '아니오', value: 'no', sortable: false,  align: 'center', width: 274},
    ],
    headers2: [
      { text: '갯수', value: 'num', sortable: false, align: 'center', width: 275},
    ...
    items2: [
      { num: '0 ~ 13', result: '평균범위'},
      { num: '14 ~ 18', result: '경도의 우울증'},
      { num: '19 ~ 21', result: '중도의 우울증'},
      { num: '22점 이상', result: '심도의 우울증'},
    ],
    u_id: '',
    u_name: '',
    u_sex: null,
