  ...
  <v-container>
    ...
    <v-layout justify-center column class="completion-form2">
      ...
      <table class="completion-table">
        ...
        <tr>
          <td class="completion-table-header" style="border-radius: 0px 0px 0px 21px">번호</td>
          <td class="completion-table-header">제시</td>
          <td class="completion-table-header">목표반응</td>
          <td class="completion-table-header">대상자 반응</td>
          ...
          <td class="completion-table-header" style="border-radius: 0px 0px 21px 0px">파일</td>
        </tr>
      </table>
    </v-layout>
