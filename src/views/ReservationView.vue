			...
			<v-layout>
					...
					<template v-slot:[`item.setting`]="{ item }">
						...
						>
							...
							>
								<g
									id="그룹_1989"
									transform="translate(-1633.733 -137)"
								>
									<path
										id="패스_1947"
										class="st0"
										d="M1763.6,161.7h252.3c58.1,0,105.1,69,105.1,154.2v154.2c0,85.2-47.1,154.2-105.1,154.2
                h-252.3c-58.1,0-105.1-69-105.1-154.2V315.9C1658.4,230.7,1705.5,161.7,1763.6,161.7z"
									/>
								</g>
								<g
									id="그룹_1988"
									transform="translate(7.521 7.159)"
								>
									<path
										id="패스_1966"
										class="st1"
										d="M377,145.4l-25.2-25.3c-2.2-2.2-5.1-3-6.5-1.6l-29.8,29.9l33.3,33.4l29.8-29.9
                C380,150.5,379.2,147.7,377,145.4"
									/>
									<path
										id="합치기_2"
										class="st1"
										d="M118,374.2l15.2-40c0.2-0.6,0.6-1.2,1.2-1.7l-0.1-0.1l171.7-171.7l31,31L165.3,363.4
                l-0.3-0.3c-0.5,0.5-1,0.9-1.7,1.2l-40,15.2c-0.5,0.2-1,0.3-1.5,0.3c-2.3,0-4.2-1.9-4.2-4.2C117.7,375.2,117.8,374.7,118,374.2z"
							...
							<template v-slot:activator="{ on, attrs }">
								...
								>
									...
									>
										...
										>
											<path
												id="패스_1947_00000137850632916346278610000016535117037519291058_"
												class="st0"
												d="M1762.4,159.5h254.7
                    ...
                    C1656.2,229.2,1703.7,159.5,1762.4,159.5z"
										...
										<g
											id="그룹_1987"
											transform="translate(7.036 6.82)"
										>
											<g>
												<defs>
													<rect
												...
												<clipPath
													id="SVGID_00000044153524365137194240000000463002274277508538_"
												>
													<use
														xlink:href="#SVGID_1_"
														style="
												...
												<g
													...
													style="
														clip-path: url(#SVGID_00000044153524365137194240000000463002274277508538_);
													"
												>
													<path
														id="패스_1967"
														class="st1"
														d="M367.7,168h-40.8v-41.6c-0.3-8.6-7.6-15.3-16.2-15H186.8c-8.6-0.3-15.9,6.4-16.2,15V168
