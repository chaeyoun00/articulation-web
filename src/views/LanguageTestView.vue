  ...
  <v-container class="outline_lang">
    <v-layout justify-center column>
      ...
      <v-row class="test" style="padding-bottom: 30px">
        <input type="radio" id="AP" name="test" value="ap" v-model="test">
        <label for="AP" style="width:91px">SCT-AP</label>
        <input type="radio" id="INS" name="test" value="ins" v-model="test"> 
        <label for="INS" style="width:94px">SCT-INS</label>
        <input type="radio" id="COM" name="test" value="com" v-model="test">
        <label for="COM" style="width:104px">SCT-COM</label>
      </v-row>

      <p>표현과제</p>
      <v-row class="test" style="padding-bottom: 50px">
        <input type="radio" id="Story" name="test" value="story" v-model="test">
        <label for="Story" style="width:121px">Story Telling</label>
        <input type="radio" id="Image" name="test" value="image" v-model="test"> 
        <label for="Image" style="width:120px">그림 설명하기</label>
        <input type="radio" id="Step" name="test" value="step" v-model="test">
        <label for="Step" style="width:120px">절차 설명하기</label>
        <input type="radio" id="COWAT" name="test" value="cowat" v-model="test">
        <label for="COWAT" style="width:85px">COWAT</label>
        <input type="radio" id="ANT" name="test" value="ant" v-model="test"> 
        <label for="ANT" style="width:59px">ANT</label>
        <input type="radio" id="priming" name="test" value="priming" v-model="test">
        <label for="priming" style="width:121px">SPT-priming</label>
        <input type="radio" id="completion" name="test" value="completion" v-model="test">
        <label for="completion" style="width:146px">SPT-completion</label>
        <input type="radio" id="CMPT" name="test" value="cmpt" v-model="test">
