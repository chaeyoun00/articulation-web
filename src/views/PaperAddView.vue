				...
				<tbody v-for="i in types.length" v-bind:key="i">
					...
					>
						...
						<td
							><v-btn
								text
								style="margin: 0px 16px; width: 31px"
								@click="ToList(i - 1)"
							>
								<img
									:src="listIcon"
				...
				await axios(config)
					.then((response) => {
						for (let i = 0; i < response.data.data.length; i++) {
							if (
								response.data.data[i].q_type === this.types[0]
							) {
								this.count[0] += 1;
								...
								response.data.data[i].q_type === this.types[1]
							) {
								this.count[1] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[1] += 1;
								...
								response.data.data[i].q_type === this.types[2]
							) {
								this.count[2] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[2] += 1;
								...
								response.data.data[i].q_type === this.types[3]
							) {
								this.count[3] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[3] += 1;
								...
								response.data.data[i].q_type === this.types[4]
							) {
								this.count[4] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[4] += 1;
								...
								response.data.data[i].q_type === this.types[5]
							) {
								this.count[5] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[5] += 1;
								...
								response.data.data[i].q_type === this.types[6]
							) {
								this.count[6] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[6] += 1;
								...
								response.data.data[i].q_type === this.types[7]
							) {
								this.count[7] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[7] += 1;
								...
								response.data.data[i].q_type === this.types[8]
							) {
								this.count[8] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[8] += 1;
								...
								response.data.data[i].q_type === this.types[9]
							) {
								this.count[9] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[9] += 1;
								...
								response.data.data[i].q_type === this.types[10]
							) {
								this.count[10] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[10] += 1;
								...
								response.data.data[i].q_type === this.types[11]
							) {
								this.count[11] += 1;
								if (response.data.data[i].isValid === 1) {
									this.valid[11] += 1;
